        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4">
            <div className="mb-8">
              ...
              <div className="w-16 h-1 bg-[#e5a37f] mb-6 rounded-full"></div>
              ...
              <div className="flex space-x-3">
                {[
                  ...
                  <a 
                    key={index}
                    href={social.href} 
                    className="group w-11 h-11 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 flex items-center justify-center hover:bg-[#b5623b] hover:border-[#b5623b] transition-all duration-300"
                  >
              ...
              <div className="flex items-center group">
                ...
                <a 
                  href="tel:+917820831901" 
                    className="text-slate-300 hover:text-[#f2c5a8] transition-colors font-medium text-sm"
                >
                  +91 7820831901
                </a>
              </div>
            ...
            <form className="space-y-4">
              <div className="relative">
                <input 
                  ...
                  className="w-full py-4 px-5 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 focus:border-[#e5a37f] focus:bg-white/10 transition-all duration-300 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#e5a37f]/20"
                />
              </div>
              <button 
                type="submit" 
                className="w-full py-4 px-6 bg-[#b5623b] hover:bg-[#954b2c] text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl shadow-lg shadow-[#b5623b]/20"
              >
                Subscribe Now
              </button>
            </form>
        ...
        <div className="container mx-auto px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2 text-slate-500">
              <Heart size={14} className="text-[#e5a37f]" />
              <span className="text-sm">
                &copy; {currentYear} Parivattan Foundation. Made with love for a better tomorrow.
              </span>
            </div>
            <div className="flex items-center space-x-6 text-sm">
              <a href="#" className="text-slate-500 hover:text-[#f2c5a8] transition-colors">
                Privacy Policy
              </a>
              <a href="#" className="text-slate-500 hover:text-[#f2c5a8] transition-colors">
                Terms of Service
